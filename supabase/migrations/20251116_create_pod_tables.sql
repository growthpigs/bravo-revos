...
-- ============================================================================
-- POD AMPLIFICATION SYSTEM - DATABASE SCHEMA
-- ============================================================================
-- This migration creates tables for the Pod Amplification feature
-- which enables automated LinkedIn reposting from team member accounts
-- to increase post visibility and engagement.
--
-- Architecture:
-- - pod_members: Team members who will repost content (one-time setup)
-- - pod_activities: Individual repost attempts with status tracking
--
...
-- MIGRATION COMPLETE
-- ============================================================================
-- Tables created: pod_members, pod_activities
