  ...
  getTool() {
    return tool({
      ...
      parameters: z.object({
        ...
        lead_id: z.string().nullable().optional().describe('Lead ID for get/update operations'),
        lead_data: z.object({
          ...
          source: z.enum(['linkedin_dm', 'linkedin_comment', 'manual', 'import', 'landing_page', 'webhook']).nullable().optional(),
          campaign_id: z.string().nullable().optional(),
          lead_magnet_id: z.string().nullable().optional(),
          tags: z.array(z.string()).nullable().optional(),
          custom_fields: z.record(z.any()).nullable().optional(),
        }).nullable().optional().describe('Lead information to store/update'),
        filters: z.object({
          status: z.enum(['new', 'contacted', 'qualified', 'converted', 'disqualified']).nullable().optional(),
          campaign_id: z.string().nullable().optional(),
          source: z.string().nullable().optional(),
          tag: z.string().nullable().optional(),
          date_from: z.string().nullable().optional(),
          date_to: z.string().nullable().optional(),
        }).nullable().optional().describe('Filters for listing leads'),
        search_query: z.string().nullable().optional().describe('Search query for finding leads'),
        tags_to_add: z.array(z.string()).nullable().optional().describe('Tags to add to lead'),
        tags_to_remove: z.array(z.string()).nullable().optional().describe('Tags to remove from lead'),
        score_adjustment: z.number().nullable().optional().describe('Points to add/subtract from engagement score'),
        activity_type: z.string().nullable().optional().describe('Type of activity to log'),
        activity_description: z.string().nullable().optional().describe('Description of activity'),
      }),
